...
export default function CustomerRegister() {
  ...
  return (
    <div className="max-w-lg mx-auto px-6 py-16">
      <h1 className="text-3xl font-bold text-ink text-center">Register as a Customer</h1>
      <p className="text-muted text-center mt-2 text-sm">Buy quality used books at a fraction of the price.</p>
